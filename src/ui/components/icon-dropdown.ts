 ...
 */
export const ELEMENT_OPTIONS: DropdownOption[] = [
 ...
 */
export function createIconDropdown(config: IconDropdownConfig): {
  getValue: () => string;
  ...
  optionsList.addEventListener('click', (e) => {
    ...
    const option = target.closest('.icon-dropdown-option') as HTMLElement;
    if (option) {
