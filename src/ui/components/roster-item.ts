 ...
 */
export function filterAndSortRoster(roster: Familiar[], options: RosterFilterOptions): Familiar[] {
  let filtered = [...roster];
 ...
 */
export function renderRosterList(roster: Familiar[], options?: RosterFilterOptions): string {
...
export function getRosterFilterOptions(): RosterFilterOptions {
  return {
    search: (document.getElementById('rosterSearchInput') as HTMLInputElement)?.value || '',
    rank: (document.getElementById('rosterFilterRank') as HTMLSelectElement)?.value || '',
    element: (document.getElementById('rosterFilterElement') as HTMLSelectElement)?.value || '',
    type: (document.getElementById('rosterFilterType') as HTMLSelectElement)?.value || '',
    wave: (document.getElementById('rosterFilterWave') as HTMLSelectElement)?.value || '',
    sortBy: (document.getElementById('rosterSortBy') as HTMLSelectElement)?.value || 'name',
  };
}
 ...
 */
export function updateRosterList(roster: Familiar[], options?: RosterFilterOptions): void {
