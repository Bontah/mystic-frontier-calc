...
import type { RGB, Bounds, CroppedImageData, IconData, Region } from './types.js';
 ...
 */
function matchesBorderColor(
  r: number,
  g: number,
  b: number
): { match: boolean; rank?: string; color?: RGB } {
 ...
 */
export function detectAndCropByBorder(
  ...
  let top = 0;
  let bottom = height;
  let detectedColor: RGB | null = null;
