...
import { loadImage, detectAndCropByBorder, extractIconRegion, preprocessForOCR, } from './image-processor.js';
...
let referenceImages = { elements: {}, types: {} };
 ...
 */
async function extractName(croppedData) {
 ...
 */
async function extractConditionalText(croppedData) {
...
export async function processImage(file, onProgress) {
    ...
    // Detect element
    const elementIconData = extractIconRegion(croppedData, scannerConfig.elementIconRegion);
